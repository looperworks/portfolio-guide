...
const DIAGRAM_MAP = {
  ...
  "1spreads": [
    { image: "class-pdf/casestudy-spread-1.jpg", title: "Spread 1", alt: "Terrain model and project abstract", caption: "Act I: Exposition. The terrain model and project abstract introduce the site and the design position." },
    { image: "class-pdf/casestudy-spread-2.jpg", title: "Spread 2", alt: "Aerial site photo and detail terrain model", caption: "Act II: Rising Action. The aerial photograph and detail model build context and reveal the terrain challenge." },
    { image: "class-pdf/casestudy-spread-3.jpg", title: "Spread 3", alt: "Winter renderings and building section", caption: "Act III: Climax. The section and winter rendering show the design confronting its hardest conditions." },
    { image: "class-pdf/casestudy-spread-4.jpg", title: "Spread 4", alt: "Model photo, approach rendering, and section", caption: "Act IV: Falling Action. Physical model, approach rendering, and section show the design resolving." },
    { image: "class-pdf/casestudy-spread-5.jpg", title: "Spread 5", alt: "Gallery interiors and floor plans", caption: "Act V: Resolution. Interior views and floor plans prove the spatial experience works." },
  ],
  2: [
  ...
  4: [
    { image: "class-pdf/casestudy-spread-1.jpg", title: "Spread 1: Act I: Exposition", alt: "Terrain model and project abstract", caption: "The protagonist is the site. The terrain model introduces the world the project inhabits; the statement declares what is at stake. A reviewer knows where we are and why it matters. What is the protagonist of your project — the site, the user, or a concept?" },
    ...
    { image: "class-pdf/casestudy-spread-5.jpg", title: "Spread 5: Act V: Resolution", alt: "Gallery interiors and floor plans", caption: "The transformed state. Interior views prove the spatial experience works. Floor plans demonstrate professional resolution. The conflict has been addressed; the thesis has been proven. Does your closing spread prove your thesis, or just show your best rendering?" },
  ],
  5: [
  ...
  11: [
    ...
    { image: "toc01-illustrated-section-grid.png", title: "TOC: Illustrated Section Grid", alt: "Two-page spread with vignette columns and project metadata", caption: "Project vignettes in a grid with metadata. Each cell previews one project. Best for portfolios with four to eight projects of similar visual weight. The grid format lets the reviewer scan all projects at once before diving in." },
    ...
    { image: "toc06-narrative-list-hybrid.png", title: "TOC: Narrative + List Hybrid", alt: "Essay spread with drawing paired with structured contents list", caption: "A drawing or essay paired with a structured contents list. The narrative side introduces the portfolio's argument; the list side provides navigation. Best for portfolios with a strong written position statement. The two halves serve different reading speeds." },
  ],
  12: [
...
**Try this now:** Label your five strongest project images as Act I through Act V. Does the sequence build tension and resolve it? If Acts III and IV feel interchangeable, the climax is missing — find the image that makes the difficulty undeniable.`,
