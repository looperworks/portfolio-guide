...
const DIAGRAM_MAP = {
  ...
  14: [
    ...
    { image: "casestudy3-spread-2.png", title: "Decision 5a: Composite Across Images", alt: "Chuchu Qi, WashU ARCH 311: cast unit iterations, massing studies, geometric diagrams, and form generation on one spread", caption: "Four media types on one surface: cast concrete units (material evidence), massing study photographs (physical process), geometric iteration diagrams (analytical logic), and form generation sequences (design development). Each image type carries different information, but the grid unifies them into a single argument about how a cast unit becomes architecture. This is composite logic across images: the grid organizes discrete elements into a unified reading." },
