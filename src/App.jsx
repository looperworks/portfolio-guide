...
function DiagramFourPillars() {
  const pillars = [
    {
      label: "Consistency",
      desc: "Establishes a recurring visual rhythm guiding the reader.",
      icon: "wave",
    },
    {
      label: "Organization",
      desc: "Manages varied content without feeling accidental.",
      icon: "blocks",
    },
    {
      label: "Cognitive Ease",
      desc: "Clear structure allows viewers to process information quickly.",
      icon: "eye",
    },
    {
      label: "Efficiency",
      desc: "Predefined rules eliminate guesswork, accelerating production.",
      icon: "clock",
    },
  ];
  ...
  return (
    <svg viewBox="0 0 420 110" style={{ width: "100%", height: "auto" }}>
      ...
      >
        THE FOUR PILLARS OF GRID LOGIC
      </text>
      {pillars.map((p, i) => {
        const ox = 12 + i * 100;
        return (
          <g key={i}>
            ...
            <g>
              {p.icon === "wave" && (
                <>
                  <path
                    d={`M ${ox + 20} ${42} Q ${ox + 25} ${38} ${ox + 30} ${42} T ${ox + 40} ${42}`}
                    stroke={T.textMid}
                    strokeWidth="1.5"
                    fill="none"
                  />
                  <path
                    d={`M ${ox + 20} ${48} Q ${ox + 25} ${44} ${ox + 30} ${48} T ${ox + 40} ${48}`}
                    stroke={T.textMid}
                    strokeWidth="1.5"
                    fill="none"
                  />
                  <path
                    d={`M ${ox + 20} ${54} Q ${ox + 25} ${50} ${ox + 30} ${54} T ${ox + 40} ${54}`}
                    stroke={T.textMid}
                    strokeWidth="1.5"
                    fill="none"
                  />
...
function DiagramColumnVsModular() {
  return (
    <svg viewBox="0 0 420 160" style={{ width: "100%", height: "auto" }}>
      ...
      {/* Simplified 3D columns */}
      <g>
        <rect x="30" y="50" width="12" height="50" fill="none" stroke={T.border} strokeWidth="1" />
        <rect x="46" y="50" width="12" height="50" fill="none" stroke={T.border} strokeWidth="1" />
        <rect x="62" y="50" width="12" height="50" fill="none" stroke={T.border} strokeWidth="1" />
        <line x1="30" y1="55" x2="62" y2="55" stroke={T.border} strokeWidth="1" />
        <line x1="30" y1="65" x2="62" y2="65" stroke={T.border} strokeWidth="1" />
        <line x1="30" y1="75" x2="62" y2="75" stroke={T.border} strokeWidth="1" />
        <line x1="30" y1="85" x2="62" y2="85" stroke={T.border} strokeWidth="1" />
      </g>
      ...
      <rect
        ...
        strokeWidth="1"
      />
      <line x1="293" y1="50" x2="293" y2="100" stroke={T.textFaint} strokeWidth="0.5" />
      <line x1="306" y1="50" x2="306" y2="100" stroke={T.textFaint} strokeWidth="0.5" />
      <line x1="319" y1="50" x2="319" y2="100" stroke={T.textFaint} strokeWidth="0.5" />
      <line x1="332" y1="50" x2="332" y2="100" stroke={T.textFaint} strokeWidth="0.5" />
      <line x1="345" y1="50" x2="345" y2="100" stroke={T.textFaint} strokeWidth="0.5" />
      <line x1="280" y1="63" x2="380" y2="63" stroke={T.textFaint} strokeWidth="0.5" />
      <line x1="280" y1="75" x2="380" y2="75" stroke={T.textFaint} strokeWidth="0.5" />
      <line x1="280" y1="87" x2="380" y2="87" stroke={T.textFaint} strokeWidth="0.5" />
      ...
      <text
        ...
        fill={T.textMid}
      >
        "A building without a grid is a pile of materials;
      </text>
      <text
        x="210"
        y="147"
        ...
        fill={T.textMid}
      >
        a portfolio without a grid is a collection of images."
      </text>
    </svg>
  );
}

function DiagramAtomicUnit() {
  return (
    <svg viewBox="0 0 420 140" style={{ width: "100%", height: "auto" }}>
      <text
        x="210"
      ...
      {/* Top-left arm: Leading */}
      <line x1="105" y1="55" x2="85" y2="35" stroke={T.border} strokeWidth="1" />
      <circle cx="105" cy="55" r="2" fill={T.border} />
      <text
        x="75"
        y="32"
        fontSize="5.5"
      ...
      {/* Top-right arm: Margins */}
      <line x1="135" y1="55" x2="160" y2="35" stroke={T.border} strokeWidth="1" />
      <circle cx="135" cy="55" r="2" fill={T.border} />
      <text
        x="155"
        y="32"
        fontSize="5.5"
      ...
      {/* Bottom-left arm: Page Height */}
      <line x1="105" y1="85" x2="85" y2="105" stroke={T.border} strokeWidth="1" />
      <circle cx="105" cy="85" r="2" fill={T.border} />
      <text
        x="55"
        y="110"
        fontSize="5.5"
      ...
      {/* Bottom-right arm: Bottom Margin */}
      <line x1="135" y1="85" x2="160" y2="105" stroke={T.border} strokeWidth="1" />
      <circle cx="135" cy="85" r="2" fill={T.border} />
      <text
        x="155"
        y="110"
        fontSize="5.5"
...
function DiagramModularBaseline() {
  return (
    <svg viewBox="0 0 420 130" style={{ width: "100%", height: "auto" }}>
      <text
        x="210"
        ...
        letterSpacing="0.12em"
      >
        THE IDEAL SYSTEM: MODULAR + BASELINE
      </text>

      {/* Left side: magnifier circle with baseline rebar */}
      <circle
        cx="100"
        cy="65"
        r="35"
      ...
      {/* Horizontal baseline lines (rebar effect) */}
      <line x1="68" y1="45" x2="132" y2="45" stroke={T.textFaint} strokeWidth="0.5" />
      <line x1="68" y1="53" x2="132" y2="53" stroke={T.textFaint} strokeWidth="0.5" />
      <line x1="68" y1="61" x2="132" y2="61" stroke={T.textFaint} strokeWidth="0.5" />
      <line x1="68" y1="69" x2="132" y2="69" stroke={T.textFaint} strokeWidth="0.5" />
      <line x1="68" y1="77" x2="132" y2="77" stroke={T.textFaint} strokeWidth="0.5" />
      <line x1="68" y1="85" x2="132" y2="85" stroke={T.textFaint} strokeWidth="0.5" />

      {/* Text lines in circle (sitting on baseline) */}
      <text
        x="75"
        y="49"
        fontSize="5"
...
function DiagramCanvasSetup() {
  return (
    <svg viewBox="0 0 420 160" style={{ width: "100%", height: "auto" }}>
      ...
      {/* Right side: Page with dimensions */}
      <rect
        x="240"
        y="30"
        width="70"
...
function DiagramMarginsSetbacks() {
  return (
    <svg viewBox="0 0 420 160" style={{ width: "100%", height: "auto" }}>
      <text
        x="210"
      ...
      <text
        ...
        fill={T.textMid}
      >
        Bottom: 48 pt (4 Units)
      </text>

      {/* Side margins with dimension lines */}
      {/* Left margin */}
      <line
        x1="70"
        y1="28"
      ...
      <text
        ...
        fill={T.textMid}
      >
        Aligning margins to the baseline prevents
      </text>
      <text
        x="210"
        y="143"
        ...
        fill={T.textMid}
      >
        grid drift at the page edges.
      </text>
    </svg>
  );
}

function DiagramTypoSpec() {
  return (
    <svg viewBox="0 0 420 120" style={{ width: "100%", height: "auto" }}>
      ...
      {/* Left: Without baseline alignment */}
      <rect
        x="30"
        y="30"
        width="150"
      ...
      <text x="40" y="52" fontSize="5.5" fontFamily={T.sans} fill={T.textMid}>
        The quick brown
      </text>
      <text x="40" y="60" fontSize="5.5" fontFamily={T.sans} fill={T.textMid}>
        fox jumps over the
      </text>
      <text x="40" y="67" fontSize="5.5" fontFamily={T.sans} fill={T.textMid}>
        lazy dog today.
      </text>

      {/* Right: With baseline alignment */}
      <rect
        x="240"
        y="30"
        width="150"
      ...
      {/* Aligned text lines */}
      <text x="250" y="51" fontSize="5.5" fontFamily={T.sans} fill={T.textMid}>
        The quick brown
      </text>
      <text x="250" y="59" fontSize="5.5" fontFamily={T.sans} fill={T.textMid}>
        fox jumps over the
      </text>
      <text x="250" y="67" fontSize="5.5" fontFamily={T.sans} fill={T.textMid}>
        lazy dog today.
      </text>
      ...
      <text
        ...
        fill={T.textMid}
      >
        The Golden Ratio of Portfolios: 10/12
      </text>
    </svg>
  );
}

function DiagramGridVocabulary() {
  return (
    <svg viewBox="0 0 420 120" style={{ width: "100%", height: "auto" }}>
      <text
        x="210"
      ...
      {/* Right side: simplified floor plan */}
      <rect
        x="240"
        y="32"
        width="150"
...
function DiagramKeyboardShortcuts() {
  const shortcuts = [
    { action: "Preview Mode", keys: "W" },
    { action: "Show/Hide Baseline", keys: "W (in text tool)" },
    { action: "Show/Hide Guides", keys: "Opt + Cmd + '" },
    { action: "Snap to Guides", keys: "Cmd + ;" },
    { action: "Fit Spread", keys: "Opt + Cmd + 0" },
  ];
...
const DIAGRAM_MAP = {
  ...
  8: [
    { component: DiagramFourPillars, title: "The Four Pillars of Grid Logic" },
    { component: DiagramColumnVsModular, title: "Building Grid to Page Grid" },
    { component: DiagramGridVocabulary, title: "The Vocabulary of Space" },
    { component: DiagramCanvasSetup, title: "Defining the Canvas" },
    { component: DiagramMarginsSetbacks, title: "Margins and Setbacks" },
    { component: DiagramModularBaseline, title: "The Ideal System: Modular + Baseline" },
    { component: DiagramAtomicUnit, title: "The 12-Point Atomic Unit" },
    { component: DiagramTypoSpec, title: "Typographic Specifications" },
    { component: DiagramKeyboardShortcuts, title: "Keyboard Shortcuts" },
  ],
  9: [
  ...
  15: [
    ...
    { image: "class-pdf/casestudy2-spread-7.jpg", title: "Spread 7: Dense Spread (Compression)", alt: "Four axonometric model views and interior rendering", caption: "Four process models in a 2×2 grid plus one large rendering. High density, high information. This spread compresses. The next spread should release. Alternation of dense and open creates the rhythm that sustains attention." },
    { image: "class-pdf/casestudy2-spread-1.jpg", title: "Spread 1: Open Spread (Release)", alt: "Generative Housing project title page", caption: "Title, subtitle, body text, one hero image, generous whitespace. A project opener that breathes. Placed after a dense technical spread, this contrast creates pacing. The grid is present but mostly empty, and that restraint communicates authority." },
  ],
  11: [
