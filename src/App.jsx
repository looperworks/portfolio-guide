...
const DIAGRAM_MAP = {
  ...
  10: [
    { image: "18-hierarchy-example.svg", title: "Typographic Hierarchy in Practice", alt: "Example of typographic hierarchy within the grid system", caption: "Four levels of type, each with a defined size, weight, and grid position: title, subtitle, body, and caption. Hierarchy is established through contrast, not decoration. Every level must sit on the baseline grid, and the size differences must be large enough to read at scanning speed." },
  ...
  11: [
    ...
    { image: "toc-example-01.png", title: "TOC Type 01: Illustrated Section Grid", alt: "Grid of architectural section vignettes with project numbers and titles", caption: "Section drawings become navigation. Each project is represented by a cropped interior vignette arranged in a grid, with bold numbers and project titles. Best for portfolios where spatial section is the primary evidence type. The grid structure previews the modular layout inside." },
    { image: "toc-example-02.png", title: "TOC Type 02: Multi-Column Text Index", alt: "Three-column typographic layout with cascading metadata", caption: "Three-column text layout with cascading metadata. No images: the typography does all the work. Best for portfolios exceeding thirty pages where visual simplicity aids navigation. The columnar structure echoes the modular grid inside." },
    { image: "toc-example-03.png", title: "TOC Type 03: Thumbnail Gallery Row", alt: "Horizontal row of equally-sized project thumbnails", caption: "A horizontal row of equally-sized thumbnails. Each project gets the same visual weight. Best for portfolios where project parity matters: no single project dominates the table of contents. Simple to execute and hard to get wrong." },
    { image: "toc-example-04.png", title: "TOC Type 04: Literary Chapter Index", alt: "Oversized serif numerals with letterspaced headings", caption: "Oversized numerals with letterspaced headings. The chapter-index format borrows from book design. Best for portfolios organized around themes or chapters rather than individual projects. The large numbers create visual rhythm down the page." },
    { image: "toc-example-05.png", title: "TOC Type 05: Bold Number Column Cards", alt: "Vertical card columns with oversized numbers and thumbnails", caption: "Vertical card columns with bold numbers and small thumbnails. Combines the structure of the text index with the preview of the gallery row. Best for portfolios with five to ten projects that need both visual preview and textual context." },
    { image: "toc-example-06.png", title: "TOC Type 06: Narrative + List Hybrid", alt: "Left page with hero image and design statement, right page with structured contents list", caption: "Statement and structure share the spread. The left page establishes the design position with a hero image and written narrative; the right page delivers a conventional contents list with project titles and page numbers. Best for portfolios that need both a conceptual frame and clear navigation. The hybrid format lets the TOC argue and organize simultaneously." },
  ],
  12: [
  ...
  13: [
    { component: DiagramChecklist, title: "Six-Category Audit Framework", caption: "Six audit categories, each targeting a different system: InDesign setup, narrative design, grid compliance, visual hierarchy, typography, and project-skill coverage. Work through them in order. Setup errors cascade into every other category." },
  ...
  casestudy: [
    ...
    { image: "class-pdf/casestudy-spread-2.jpg", title: "Spread 2: Confrontation (Scale)", alt: "Aerial site photo and detail terrain model", caption: "Keywords: 'Alpine,' 'terrain.' Act II: confrontation. Image types: context + process. The aerial photograph establishes scale; the detail model introduces the method of working with erosion." },
    ...
    { image: "class-pdf/casestudy-spread-4.jpg", title: "Spread 4: Resolution (Design)", alt: "Model photo, approach rendering, and section", caption: "Keywords: 'embeds,' 'spatial experience.' Act III: resolution. Image types: process + outcome. Massing, sequence, and structure. Each drawing answers a question the portfolio already asked." },
    { image: "class-pdf/casestudy-spread-5.jpg", title: "Spread 5: Resolution (Proof)", alt: "Gallery interiors and floor plans", caption: "Keywords: 'museum,' 'spatial experience.' Act III: resolution. Image type: outcome. Interior views prove inhabitation; plans prove program. Every claim in the statement has been drawn." },
  ],
};
...
const MODULES = [
  {
    ...
    part: "Narrative",
    overview: `A portfolio is not a collection of coursework. It is a constructed argument. Every decision about what to include, how to sequence it, and where to place it on the page is an act of design. The portfolio is not separate from your work; it is your work, reframed for an audience. It speaks before you do: before you enter a review, an interview, or a committee, the layout has already made your case or lost it. This is not abstract. The portfolio is what gets you hired at the firm you want to work for. It is what earns the graduate scholarship that funds your next three years. It is the single document that determines whether a reviewer spends five more minutes with your work or moves on to the next applicant. Reviewers typically spend thirty seconds on an initial scan. In that window, you have either earned a closer reading or you have not.
...
**Try this now:** Sketch three cover options for your portfolio, each using a different typology from the seven above. Which one reinforces your Red Thread? Show all three to a classmate and ask which one they would open first. Then open three architecture portfolios online and classify each table of contents by type: thumbnail gallery, text index, literary chapter, column cards, narrative hybrid, or illustrated grid. Which format best matches your portfolio's length and structure?`,
  ...
  },
  {
    ...
    part: "Production",
    overview: `Color in a portfolio is a system, not an accent. Three palette families recur across architectural portfolios. Monochrome palettes use one hue family plus neutrals (deep grays, charcoals, blacks) for quiet authority; they remain the most common choice because they disappear and let the work speak. Warm accent palettes add a single deliberate warm color (terracotta, sand, gold) to a neutral base, tying the work to materiality and craft. Cool accent palettes introduce a cooler hue (pale cyan, slate blue, sage) for contrast without competing with project images. A fourth approach is project-coded color: each project receives a signature hue, used consistently in headers, dividers, and diagrams across its section. The palette should connect to the design position that governs the portfolio's Red Thread: a project about erosion might favor earth tones; a project about light might favor high-contrast neutrals.
...
**6. Project-Skill Coverage.** Map each project against the competencies it demonstrates: design development, technical resolution, digital fabrication, hand drawing, research, and writing. If one column is empty, either add a project that covers it or acknowledge the gap in your statement. The matrix reveals what the portfolio argues about your range and where the argument is thin.
...
Next, build a layer architecture. Create five layers from top to bottom: Guides (locked, hidden in export) for non-printing alignment aids, Notes for instructor feedback, Text for all type, Images for placed graphics, and Background for bleeds and color fills. This strict separation prevents accidental selection of images when editing text, keeps construction guides out of the exported PDF, and isolates instructor markup from production content. As the file grows past twenty pages, a clean layer structure is the difference between a navigable file and an unmanageable one.
