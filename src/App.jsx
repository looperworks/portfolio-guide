...
const DIAGRAM_MAP = {
  ...
  8: [
    ...
    { image: "02-historical-grid-comparison.svg", title: "Historical Grid Comparison", alt: "Comparison of historical grid systems from Miletus to Le Corbusier", caption: "The grid is not a modern invention. From the orthogonal city plan of Miletus to the Ken module in Japanese timber construction to Le Corbusier's Modulor, architects have always organized space through repeating structural units. The portfolio grid inherits this logic directly." },
    { image: "03-structural-vs-page-grid.svg", title: "Structural Grid to Page Grid", alt: "Diagram showing how building structural grids translate to page grids", caption: "A structural column defines rhythm and load-bearing zones. A page column defines rhythm and content zones. Bays correspond to modules, beam lines correspond to baselines. The translation from building to page is not metaphorical; it is structural." },
    { image: "04-pile-vs-system.svg", title: "Pile vs. System", alt: "Comparison of unstructured layout versus grid-based system", caption: "Without a grid, content is a pile: images float, text blocks shift between pages, and the reader has no predictable path. With a grid, every element has a coordinate. The difference is not aesthetic preference; it is whether the portfolio can be read." },
