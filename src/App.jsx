...
const DIAGRAM_MAP = {
  ...
  8: [
    { image: "01-grid-anatomy-overview.svg", title: "Grid Anatomy Overview", alt: "Annotated page grid showing columns, gutters, modules, margins, and baseline grid" },
    { image: "02-historical-grid-comparison.svg", title: "Historical Grid Comparison", alt: "Comparison of historical grid systems from Miletus to Le Corbusier" },
    { image: "03-structural-vs-page-grid.svg", title: "Structural Grid to Page Grid", alt: "Diagram showing how building structural grids translate to page grids" },
    { image: "04-pile-vs-system.svg", title: "Pile vs. System", alt: "Comparison of unstructured layout versus grid-based system" },
    { image: "05-four-grid-types.svg", title: "Four Grid Types", alt: "Manuscript, column, modular, and hierarchical grid types compared" },
    { image: "06-consistency-across-spreads.svg", title: "Consistency Across Spreads", alt: "Multiple spreads demonstrating consistent grid application" },
    { image: "07-modular-baseline-overlay.svg", title: "Modular + Baseline Overlay", alt: "Modular grid with baseline grid overlay showing alignment system" },
    { image: "08-baseline-drift-mistake.svg", title: "Baseline Drift", alt: "Common mistake showing text drifting off baseline grid" },
    { image: "09-indesign-workspace.svg", title: "InDesign Workspace", alt: "InDesign interface showing grid setup panels and workspace" },
    { image: "10-panel-closeups.svg", title: "Panel Closeups", alt: "Detailed views of InDesign grid configuration panels" },
    { image: "11-page-measurements.svg", title: "Page Measurements", alt: "Page dimensions and margin measurements in points" },
    { image: "12-baseline-math.svg", title: "Baseline Grid Math", alt: "Mathematical breakdown of 840pt page height divided by 12pt baseline" },
    { image: "13-module-anatomy.svg", title: "Module Anatomy", alt: "Detailed anatomy of a single grid module with dimensions" },
    { image: "slide16-phase2-atomic-unit.svg", title: "The 12-Point Atomic Unit", alt: "Diagram showing 12pt as the atomic unit for all grid decisions" },
    { image: "14-indesign-setup-steps.svg", title: "InDesign Setup Steps", alt: "Step-by-step InDesign document and grid setup procedure" },
    { image: "15-shortcut-reference.svg", title: "Keyboard Shortcuts", alt: "Essential InDesign keyboard shortcuts for grid management" },
    { image: "16-visual-glossary.svg", title: "Visual Glossary", alt: "Visual glossary of grid terminology with architectural parallels" },
    { image: "17-leading-closeup.svg", title: "Leading Closeup", alt: "Detailed view of text leading and baseline alignment" },
    { image: "18-hierarchy-example.svg", title: "Typographic Hierarchy", alt: "Example of typographic hierarchy within the grid system" },
    { image: "19-white-space.svg", title: "White Space as Structure", alt: "Diagram showing intentional white space in grid-based layouts" },
  ],
  9: [
