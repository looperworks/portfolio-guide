...
**Module 6: The Project Statement.** The original abstract begins with description: it credits the instructor, uses passive voice, and offers no position. The compressed version declares: "An Alpine museum embeds into eroding terrain to make climate change a spatial experience." One sentence. Active voice. A testable claim. Every image in the portfolio can be measured against it. That is a project statement.`,
  keyInsight: null,
};
