...
Arrange those drawings in the order the keywords appear in the statement. The statement already contains a narrative logic: it moves from site to problem to design-move to result. In practice, not every category earns its own spread. Problem keywords often surface within site or design-move spreads rather than standing alone, and a complex design move may span two or more spreads. The four categories are an analytical tool, not a page count. That sequence becomes the graphic outline: a list of images organized not by when they were produced but by what they argue. The outline is the bridge between writing and layout. Without it, the jump from statement to InDesign fills pages with whatever images happen to be closest at hand.
