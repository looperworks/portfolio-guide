...
const DIAGRAM_MAP = {
  ...
  3: [
    ...
    { image: "class-pdf/casestudy-spread-2.jpg", title: "Spread 2: Site Keywords", alt: "Aerial site photo and detail terrain model", caption: "Keywords: 'Alpine,' 'terrain.' The aerial photograph proves the Alpine context at scale. The detail model proves the terrain the building must negotiate. Site keywords demand environmental evidence. What site keywords does your statement contain, and do you have drawings for each?" },
    { image: "class-pdf/casestudy-spread-3.jpg", title: "Spread 3: Design-Move Keywords", alt: "Winter renderings and building section", caption: "Keywords: 'embeds into,' 'eroding terrain.' The section proves the embedding: architecture cut into slope. The rendering proves the building survives its environment. Design-move keywords demand design evidence." },
...
The mapping process works by extraction. Underline the operative keywords in the statement, then sort them into four categories. Site keywords (location, existing condition, environment) demand site plans, aerial photographs, and historical mappings. Problem keywords (tension, constraint, what is at stake) demand analytical diagrams, data overlays, or documentation of existing failure. Design-move keywords (strategy, method, structural response) demand massing studies, structural logic, and process diagrams. Result keywords (transformation, experience, resolved state) demand renderings, sections, and detail drawings. Each keyword generates a requirement. Each requirement names a drawing.
