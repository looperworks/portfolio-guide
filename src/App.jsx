...
**Finding Your Position.** The compression exercise applied to this project. Paragraph: "The design converts a decommissioned Cold War bunker into an Alpine museum by cutting into eroding mountainside terrain, creating a continuous path that makes geological time visible as visitors move between landscape and gallery." Sentence: "An Alpine museum embeds into eroding terrain to make climate change a spatial experience." Word: Erosion. Thread test: erosion recurs across every spread — terrain models shaped by geological force, sections carved into slope, galleries embedded in eroded ground, visitor paths that descend into the earth. The word is not a label. It is the lens that governs every image.

**The Project Statement.** The original abstract begins with description: it credits the instructor, uses passive voice, and offers no position. The compressed version declares: "An Alpine museum embeds into eroding terrain to make climate change a spatial experience." One sentence. Active voice. A testable claim. Every image in the portfolio can be measured against it. That is a project statement.

**Structuring the Narrative.** The five spreads follow a three-act framework. Opening (Spreads 1 and 2): the terrain model, photographed in dramatic light, declares the thesis (this project is about ground shaped by force); the aerial site photograph and detail model locate the intervention in the alpine landscape and show the first architectural incision into the slope. Development (Spreads 3 and 4): winter renderings show the building nearly vanishing into the snowy terrain, a night rendering reveals the entry as a glowing slit in the ground, and full building sections demonstrate how the architecture descends below grade through ramped circulation. Resolution (Spread 5): interior gallery renderings and floor plans show visitors inhabiting the eroded ground, looking outward at the landscape from within the earth. The arc moves from landscape to building to inhabitation.

**Sequencing for Impact.** The portfolio opens not with a rendering but with a terrain model: a physical object photographed in dramatic raking light, showing ridges and valleys carved by erosive forces. Before any architecture appears, the viewer understands that this project is about ground. That is the strongest possible opening because it frames everything that follows. The portfolio closes with interior gallery views where visitors occupy the spaces carved into the slope and floor plans that reveal the angular footprint cut into the hillside. Strongest first, most resonant last.

**Four Image Types.** Concept: the terrain model (Spread 1), establishing erosion as the governing idea before any building appears. Context: the aerial site photograph (Spread 2), showing glaciated alpine valleys between Gstaad and Les Diablerets, and winter renderings (Spread 3) grounding the project in geography and climate. Process: the detail terrain model showing the architectural incision (Spread 2), the building sections (Spreads 3 and 4) showing ramped circulation descending into the slope, and the physical model with the roof emerging as a geometric cut in the snow (Spread 4). Outcome: the interior gallery renderings and floor plans (Spread 5), demonstrating the resolved spatial experience of inhabiting eroded ground. Each type appears where it belongs in the narrative arc.

**Storyboarding & Spread Sequencing.** Each of the five spreads advances the argument without repeating the previous one. Spread 1 establishes the thesis through terrain. Spread 2 grounds it in site and shows the first incision. Spreads 3 and 4 develop the architecture through renderings and sections. Spread 5 resolves with inhabited space. The two-track reading works: at skim speed, the terrain-to-gallery arc is legible from images alone; at study speed, the sections and plans reveal the spatial logic of embedding into eroded ground.`,
  keyInsight: null,
};
